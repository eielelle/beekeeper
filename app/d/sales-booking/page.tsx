...
export default function SalesBookingPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-muted/20">
      {/* HEADER SECTION */}
      <header className="sticky top-0 z-20 flex flex-col border-b bg-background bg-primary px-6 pt-4 pb-2 shadow-sm">
        {/* ROW 1: Search Group & Cart Button */}
        <div className="flex w-full items-center justify-between gap-4">
          {/* Native Shadcn InputGroup */}
          <div className="max-w-3xl flex-1">
            <InputGroup className="bg-white dark:bg-white">
              <InputGroupAddon>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <InputGroupButton className="w-[160px] justify-between text-sm font-normal">
              ...
              <InputGroupInput
                type="search"
                placeholder="Search SKUs, items, or brands..."
                value={searchQuery}
          ...
          <Sheet open={isCartOpen} onOpenChange={setIsCartOpen}>
            <SheetTrigger asChild>
              <Button variant="default" className="relative h-10 shrink-0 px-4">
                <ShoppingCart className="mr-2 h-4 w-4" />
                Cart
                {cartItemCount > 0 && (
                  <Badge
                    variant="destructive"
                    className="absolute -top-2 -right-2 flex h-5 w-5 justify-center rounded-full border-2 border-background p-0"
                  >
                    {cartItemCount}
                  </Badge>
                )}
        ...
        {/* ROW 2: Navigation Links & View Toggles */}
        <div className="flex items-center justify-between">
          <nav className="flex items-center gap-2 overflow-x-auto">
            ...
            <Button
              ...
              onClick={() => router.push("/d/sales-booking/orders")}
            >
              Orders
            </Button>
            <Button
          ...
          {/* View Mode Toggles */}
          <div className="flex shrink-0 items-center rounded-md border bg-muted/20 p-1">
            <Button
      ...
      <main className="flex-1 overflow-y-auto p-6">
        {isLoadingCatalog ? (
          ...
          <div className="mt-4 flex h-64 flex-col items-center justify-center space-y-3 rounded-lg border border-dashed bg-background">
                ...
                >
                  <div className="flex flex-col">
                    <div className="mb-1 flex items-center gap-2">
                      <h3 className="text-sm font-semibold">{sku.item_name}</h3>
                      {sku.brand && (
